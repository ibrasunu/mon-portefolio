      ...
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-content text-s md:text-m font-light pl-1">{company}</p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-content text-s md:text-m font-light pl-1">{location}</p>
          </div>
        </div>
        <p className="text-content text-s md:text-m font-light pl-1 min-w-fit">{duration}</p>
      </div>
    </article>
  );
}
